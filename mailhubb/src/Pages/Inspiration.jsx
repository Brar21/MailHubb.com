...
function Inspiration() {
    ...
    return <>
        ...
        <Box width='45%' m='2rem auto'>
            ...
            <Box position='absolute' mt='-7.8%' w={350} textAlign='start' bg='white' p={2}>
        ...
        <Box w='50%' display='flex' flexDirection='row' m='auto'>
            <Box width='45%' m='auto'mr='-30px'>
        ...
        <Box width='45%' m=' 2rem auto'>
            ...
            <Box position='absolute' mt='-9.3%' w={350} textAlign='start' bg='white' p={2}>
                <Text fontWeight='500' color='red'>
                    Workshop
                </Text>
        ...
        <Box w='50%' display='flex' flexDirection='row' m='2rem auto'>
            <Box width='45%' m='auto' mr='-15px'>
