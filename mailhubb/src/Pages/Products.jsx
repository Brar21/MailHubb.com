...
function Products() {
    ...
    return <>
        <Navbar />
        <Box w='100%'   m='auto'>
            <Box w='100%'  display='flex'  flexDirection='row' m='auto' textAlign='start' gap={1}>
                <Box p='8rem 1rem'>
                    <Text fontSize={14} ml={1} fontWeight='500'>Digital Marketing Storage</Text>
                ...
                <Image w={930} h={910} src="https://eep.io/images/yzco4xsimv0y/2Qk5spMGPk6pKEZ7QZftjS/5ee1b1974245cdedd663375d61f1585c/Mailchimp-Content-Studio-Hero.png?w=1520&fm=webp&q=70"></Image>
            </Box>
        </Box>
        <Box w='100%' bg='#e7b75f'  m='6rem auto 0'>
            <Box w='100%' p='1rem' display='flex' pt='6rem' flexDirection='row' m='auto' textAlign='start' gap={1}>
                <Image w={840} h={663} src="https://eep.io/images/yzco4xsimv0y/Hpaa3qth7QfgWM98yjalY/7379aefe6d76b6e09079e660fbe2401e/Mailchimp-Content-Studio-AUI.png?w=842&fm=webp&q=80"></Image>
                <Box p='8rem 1rem'>
        ...
        <Box w='100%'  m='6rem auto 0'>
            <Box w='100%' p='4rem' display='flex'  flexDirection='row' m='auto' textAlign='start' gap={1}>
                <Box p='5rem'>

                    <Heading fontSize='40px' ml={1} fontFamily='mono'>Bring all your work together</Heading>
                    <Text m='3rem 0' ml={1} fontSize={24}>Organize all your creative digital assets in one Mailchimp account, so you’ll always have access to the files you need. When you're ready to launch a new campaign, our marketing storage platform will have your back.</Text>

                </Box>
                <Image w={840} h={663} src="https://eep.io/images/yzco4xsimv0y/2faWyLgdDHto0Q2u5zWAYk/5a81ff0c272a594dc75879c3504a3032/Mailchimp-Content-Studio-Bring-All-Your-Work-Together.png?w=842&fm=webp&q=80"></Image>
        ...
        <Box w='60%' m='auto' textAlign='start'>
            <Heading fontSize={48} fontWeight='500' textAlign={'center'} fontFamily='mono'>Content Studio - Benefits</Heading>
        </Box>
        <Box w='100%' m='6rem auto 0'>
            <Box w='100%' p='0 4rem'  display='flex'  flexDirection='row' m='auto' textAlign='start' gap={10}>
        ...
        <Box w='100%' m='0 auto 1rem'>
            <Box w='100%' p='4rem' display='flex'  flexDirection='row' m='auto' textAlign='start' gap={10}>
                ...
                <Box p='4rem'>
                    <Heading fontSize='40px' ml={10} fontFamily='mono'>Create a cohesive brand experience</Heading>
                    <Text m='1rem 0' ml={1} fontSize={24}>Set a default logo to include in each marketing campaign, then re‑use your digital assets to keep all your marketing—across multiple channels—consistent and on‑brand.</Text>
                </Box>
            </Box>
        </Box>
        <Box w='100%' m='0rem auto 1rem'>
            <Box w='90%' p='4rem' display='flex' flexDirection='row' m='auto' textAlign='start' gap={10}>
                ...
                <Box p='4rem'>
                    <Heading fontSize='40px' ml={10} fontFamily='mono'>Quickly go from concept to publish</Heading>
                    <Text m='1rem 0' ml={1} fontSize={24}>When you upload your images and other creative assets to our marketing asset management software, you can add them to any campaign in just a few clicks.</Text>
                </Box>
            </Box>
        </Box>
        <Box w='100%' m='0rem auto 1rem'>
            <Box w='100%' p='4rem' display='flex' flexDirection='row' m='auto' textAlign='start' gap={10}>
                ...
                <Box p='4rem'>
                    <Heading fontSize='40px' ml={10} fontFamily='mono' textAlign={'start'}>Collaborate with your whole team</Heading>
                    <Text m='1rem 0' ml={1} fontSize={24}>The content studio makes it easy to find, share, and repurpose content, so your team can work on campaigns together—and everyone stays on the same page.</Text>
                </Box>
            </Box>
        </Box>
        <Box width='70%' m='auto'>
